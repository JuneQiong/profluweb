...
public class MabatisPlusGenerator {
    ...
    //生成文件所在项目路径
    private static String baseProjectPath = "D:\\lxqworkspace\\profluweb";

    //基本包名
    private static String basePackage="cn.proflu.profluweb";
    //作者
    private static String authorName="Wu Huiqiong";
    //要生成的表名
    private static String[] tables= {"wx_interface_info"};
    //table前缀
